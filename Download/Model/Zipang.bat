...
call %SDXL_WEB_UI%\setup\Download.bat Anmg zipang_XL_test03.fp16.safetensors ^
https://huggingface.co/deadman44/SDXL_Photoreal_Merged_Models/resolve/main/zipang_XL_test03.fp16.safetensors
if %errorlevel% neq 0 ( popd & exit /b %errorlevel% )

call %SDXL_WEB_UI%\setup\Download.bat Pony ponypang_XL_test.safetensors ^
https://huggingface.co/deadman44/SDXL_Photoreal_Merged_Models/resolve/main/ponypang_XL_test.safetensors
if %errorlevel% neq 0 ( popd & exit /b %errorlevel% )
...
call %SDXL_WEB_UI%\setup\Download.bat Zipang myjs_XL_ponypang.safetensors ^
https://huggingface.co/deadman44/SDXL_Photoreal_Merged_Models/resolve/main/myjs_XL_ponypang.safetensors
if %errorlevel% neq 0 ( popd & exit /b %errorlevel% )
