...
set EASY_SDXL_WEBUI_DIR=EasySdxlWebUi-main
...
echo /QSY .\SdxlWebUi\setup\lib\%EASY_SDXL_WEBUI_DIR%\ .
xcopy /QSY .\SdxlWebUi\setup\lib\%EASY_SDXL_WEBUI_DIR%\ .
...
call SdxlWebUi-ResetConfig.bat
if %errorlevel% neq 0 ( popd & exit /b %errorlevel% )
